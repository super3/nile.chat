<template>
	<div class="font-sans antialiased h-screen flex">
		...
		<div class="bg-indigo-darkest text-purple-lighter flex-none p-4 hidden md:block">
			<div class="cursor-pointer mb-4" v-on:click="setInstance('big.chat')">
			...
			<div class="cursor-pointer mb-4" v-on:click="setInstance('ovso')">
				<div class="bg-red-lighter opacity-25 h-12 w-12 flex items-center justify-center text-black text-2xl font-semibold rounded-lg mb-1 overflow-hidden">
					O
				</div>
