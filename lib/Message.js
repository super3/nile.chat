...
module.exports = class Message {
	...
	async save() {
		...
		await redis.set(`${this.instance}:channel:${this.channel}:message:${this.id}`, JSON.stringify(this));
		await redis.lpush(`${this.instance}:channel:${this.channel}:messages`, this.id);
	}
